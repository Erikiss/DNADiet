...
cells.append(md(
    ...
    "",
    "> ⚠️ **Datenschutz:** Deine Roh-DNA bleibt in dieser Colab-Sitzung. Es wird nur ein",
    "> minimales Genotyp-Profil erzeugt. Lade dieses Profil nur in ein **privates** Repo",
...
cells.append(md(
    ...
    "",
    "Damit der **taegliche GitHub-Tracker** deine echten Daten nutzt, gibt es zwei Wege:",
    "",
    "### Weg A – Datei ins (private!) Repo committen",
    "1. Lege `profile.json` unter `genome/profile.json` ab.",
    "2. Da die Datei aus Sicherheitsgruenden in `.gitignore` steht, bewusst hinzufuegen:",
    "   ```bash",
    ...
    "",
    "> Nutze dafuer ein **privates** Repository – die Reports enthalten interpretierte Genotypen.",
    "",
    "### Weg B – Profil als GitHub-Secret (nichts Genetisches im Repo-Baum)",
